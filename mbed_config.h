...
// Macros
#define CMSIS_NVIC_VIRTUAL                               // defined by library:uvisor-lib
#define CMSIS_VECTAB_VIRTUAL                             // defined by library:uvisor-lib
#define TARGET_UVISOR_SUPPORTED                     1    // defined by application
#define UNITY_INCLUDE_CONFIG_H                           // defined by library:utest
#define FEATURE_UVISOR                              1    // defined by application
